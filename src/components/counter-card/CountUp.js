...
class CountUp extends Component {
  ...
  componentDidMount() {
    ...
    if (typeof children === 'function' && delay !== 0) {
      return
    }
    ...
    if (typeof this.props.children === 'function') {
      ...
      warning(
        this.containerRef.current &&
          ...
          `Couldn't find attached element to hook the CountUp instance into!
          Try to attach "containerRef" from the render prop to a an HTMLElement,
          eg. <span ref={containerRef} />.`,
      );
    }
