        ...
        <div className="container header_container">
          <Row rowClass="flex flex-between">
            ...
            <div className="header_actions">
              ...
              <div className="action_menu_button" onClick={this.showUserMenu}>
              ...
              >
                {window.location.pathname !== '/profile' && (
                  <Link to="/profile" className="action_menu__item" onClick={this.hideMenu}>
                    Profile
                  </Link>
                )}

                {window.location.pathname !== '/admin' && this.props.isAdmin && (
                  <Link to="/admin" className="action_menu__item" onClick={this.hideMenu}>
                    Admin
                  </Link>
                )}

                <Link to="/logout" className="action_menu__item" onClick={this.hideMenu}>
                  Sign Out
                </Link>
              </div>
            </div>
