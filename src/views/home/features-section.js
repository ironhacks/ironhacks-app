...
const FeaturesSection = () => {
  let featureList = [
    ...
    {
      title: 'WORKSPACE',
      description: 'A workspace that integrates to Jupyter Lab and Big Query that allows you to hack in the cloud with no set-up time and costs',
      image: 'feature-workspace_360x200.jpg?alt=media&token=24ecc8da-d207-4f87-ab7f-45b0d62861bf',
    },
    {
      title: 'FEEDBACK',
      description: 'A dashboard with real-time ratings about your submissions as well as access to your peer\'s solutions.',
