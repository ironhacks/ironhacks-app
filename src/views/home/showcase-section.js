    ...
    <>
      <Row>
        <Col>
          ...
          <p>
            In prior years, IronHackers with no coding experience produced interactive visualizations within 10 to 21
            days! Explore some of the showcases of students who participated in an affordable housing challenge.
          </p>
        </Col>
      </Row>
      ...
      <Row>
        <Col>
          ...
          <p>
            ...
            In this IronHacks Challenge, students developed a mashup that integrated, analyzed and interactively
            displayed open data to support hypothetical new students by evaluating and ranking the 59 habitable
            districts in New York City. Mashups used a diverse set of decision parameters (metrics) to find the Top 10
            districts based on single parameters and the Top 3 districts based on the average of three key parameters of
            safety, affordability and distance to NYU Stern.
          </p>
        </Col>
      </Row>
      <Row>
