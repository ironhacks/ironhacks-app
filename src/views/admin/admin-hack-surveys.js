  ...
  render() {
    return (
      <SectionContainer onSubmit={this.saveSurveys}>
        ...
        <p>
          Bellow you can provide some Qualtrics survey links to complement your
          hack. These surveys are splited in two main types: Reseach related
          surveys and tutorial quizzes.
        </p>
        <Separator primary />
        <h3>Research proccess</h3>
        <p>
          These surveys are mean to be used by you to control the experiment
          develompent, you can think of them as "breackpoints" during he contest
          used to ask questions to the partipants.
        </p>
        <p>
          You can place a Qualtrics survey on 3 different places: at the
          registration process (as part of it), any time a participant submit a
          project to evaluation (per phase) and when the hack ends.
        </p>
        <label>
