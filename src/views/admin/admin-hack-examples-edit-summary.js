...
class AdminExampleEditSummary extends Component {
  constructor(props) {
    super(props)
    ...
    return (
      <>
        <Section sectionClass="py-2">
          <h2 className="h3 font-bold">{`${this.props.hackName} Edit Example Summary`}</h2>
...
export default withRouter(AdminExampleEditSummary)
