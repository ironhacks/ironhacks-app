...
class AdminExampleNewNotebook extends Component {
  constructor(props) {
    super(props)
    this.state = {
      exampleData: {
    ...
    return (
      <>
        <Section sectionClass="py-2">
          <h2 className="h3 font-bold">{`${this.props.hackName} New Example Notebook`}</h2>
...
export default AdminExampleNewNotebook
