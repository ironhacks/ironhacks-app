        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              ...
              Digital Innovation (RCODI) has set forth to launch an IronHacks series to help leaders in making the right
              decisions as we are moving through this pandemic. Leaders in our country who are responsible for
              protecting their citizens' welfare and quality of life face difficult questions, such as: When and where
              do citizens expose themselves and others the most to COVID-19 risk? Which regions and places (stores,
              restaurants, etc.) are predicted to be hotspots for social crowding increasing the risk of virus spread?
            </p>
            ...
            <p>
              Watch the videos of two leaders in the State of Indiana to learn why they need YOU as soldiers of the
              COVID-19 pandemic behind the screen.
            </p>
          </Col>
      ...
      <Section>
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              Our COVID-19 Data Science Challenges invite participants to build statistical models and visualizations
              that monitor and predict social movement behavior during the COVID-19 pandemic over time. The goal is to
              predict weekly patterns of movement and social interaction in our local communities to understand COVID-19
              risks.
            </p>
            ...
            <p>
              Participants have access to BIG actual, granular and temporal data they typically do not have access to:
              Data about social distancing behavior, foot traffic, COVID-19 incidents, as well as executive orders. This
              data is also used by state governments in the US as well scientists who try to understand social movements
              during COVID-19 pandemic.
            </p>

            <p>
              Equipped with this data, participants will work in the IronHacks workspace with JupyterLab and access to
              BigQuery to create novel and useful statistical models and visualizations using Python and R. Participants
          ...
          <Col>
            ...
            <div className="my-5">
              <div className="flex">
                ...
                <div className="font-italic">
                  "The excitement to know how my model would perform after every round kept me enthused till the end!
                  These predictions can give insights into social distancing norms and implement necessary precautions."
                </div>
              </div>
              <div className="my-4">
            ...
            <div className="my-5">
              <div className="flex">
                ...
                />
                <div className="font-italic">
                  "My greatest experience was being able to try on algorithms I never use. I also had the freedom to
                  experiment, instead of defaulting to certain known models due to crunching code within 24 hours like
                  typical hackathons."
                </div>
              </div>
              <div className="my-4">
                Harsha Pavuluri, the August 2020 Challenge second-place winner and Purdue University student.
              </div>
            </div>
          </Col>
        </Row>
      ...
      <Section>
        <Row rowClass="py-2">
          <Col>
            ...
            <p>Each participant's notebook will be evaluated in several dimensions. Examples are:</p>
            ...
            <p>More details on the evaluation criteria will be released at the start of the competition.</p>
          </Col>
        </Row>
      </Section>
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              ...
              <strong>JupyterLab</strong> and <strong>BigQuery</strong>
              integration and many powerful features to create novel and useful models and visualizations. It also
              offers training and tutorials, as well as a personal dashboard to view scores and progress through the
              competition. After registration, participants can warm-up, practice their skills and query sample data
              until sufficient participants have joined to launch the competition. After the start of the competition, a
            ...
            <ul className="list">
              ...
              <li>
                ...
                invitation, usually followed by multiple interim and one final submission
              </li>

              <ul className="list">
                <li>
                  <strong>Interim submissions:</strong> At multiple interim submission points, you will receive
                  immediate feedback on your current standing, giving you the opportunity to improve over time.
                </li>
                <li>
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <List
              items={[
                <p>
                  <strong>COVID-19 Data Science Challenge Summer 2020:</strong> This challenge is complete. Check out
                  the results here!
                </p>,
                <p>
                  <strong>COVID-19 Data Science Challenge Fall 2020: Protect Purdue:</strong> There will be two
                  challenges - one focused on Python and one focused on R. These challenges will open for registration
                  on November 18th. We plan to acceptopen for submissions a week later.
                </p>,
              ]}
            />
          </Col>
          ...
          <Col>
            ...
            <ul className="list">
              <li>
                ...
                to learn more about the upcoming Protect Purdue Challenge and other future challenges and timelines.
              </li>
              <li>
                Reach out to us with any questions by sending us an{' '}
                <a href="mailto:c562462b.groups.purdue.edu@amer.teams.ms" target="_blank" className="text-underline">
                  email
                </a>
              </li>
              <li>
                Watch our recent publicly accessible{' '}
                <a className="link--underline" href="https://www.youtube.com/watch?v=vnT587J-wis&feature=youtu.be">
                  Info Sessions.
                </a>
              </li>
              <li>
              ...
              <li>
                And do not forget to Register for one of the Challenges (R or Python) to save your space in the
                competition. Registration has opened!
              </li>
            </ul>
          </Col>
        </Row>
