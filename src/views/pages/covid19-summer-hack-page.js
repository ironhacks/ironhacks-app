        ...
        <Row rowClass="mb-2">
          <Col colClass="text-center">
            <Img
              ...
              fileName={
                'upcoming-covid19-cta.png?alt=media&token=06c537fe-c97a-47dd-bbd8-ebf03ae0f4b9'
              }
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              ...
              to facilitate governments and citizens in making the right decisions as we are moving
              through this pandemic. Leaders in our country who are responsible for protecting their
              citizens' welfare and quality of life face difficult questions, such as: When and
              where do citizens expose themselves and others the most to COVID-19 risk? Which
              regions and industries are predicted to suffer the most from COVID-19, both
            ...
            <p>
              In Summer and Fall 2020, we invite aspiring data scientists to join the IronHacks
              crowd in a COVID-19 Data Science Challenge to predicting COVID-19 impacts. You can
              watch our recent{' '}
              <a
                href="https://www.youtube.com/watch?v=ta5i7_I5VT8&feature=youtu.be"
      ...
      <Section>
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              The COVID-19 Data Science Challenges will focus on prediction tasks and data
              visualizations. We will provide our IronHacks participants with access to a selection
              of large and granular datasets related to COVID-19 incidents as well as social and
              economic effects. Equipped with this data, participants will work in the IronHacks
              workspace with JupyterLab and access to BigQuery to create novel and useful
              statistical models and visualizations using Python and R. Participants will submit
              Jupyter notebooks and their outputs (html and markdown files).
            </p>
          </Col>
        </Row>
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              The evaluation criteria and scorecard will be released at the start of the
              competition.
            </p>
          </Col>
        </Row>
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              ...
              <strong>BigQuery</strong> integration and many powerful features to create novel and
              useful models and visualizations, such as tutorials and a personal dashboard. After
              registration, participants can warm-up until sufficient participants have joined to
              launch the competition. After the start of the competition, a multiphase process will
              start. Each challenge moves through a four-phased process after a registration and
              warm-up phase.
            </p>
            ...
            <ul className="list">
              ...
              <li>
                ...
                competition starts based on invitation, followed by 3 interim and one final
                submission.
              </li>

              <ul className="list">
                <li>
                  <strong>3 interim submissions:</strong> At three interim submission points, you
                  will receive immediate feedback on your current standing, giving you the
                  opportunity to improve over time.
                </li>
                <li>
                  <strong>Final submission:</strong> There will be a final forth submission before
                  we identify the winners.
                </li>
              </ul>

              <li>
                <strong>Award ceremony:</strong> At a virtual award ceremony we will announce the
                winners.
              </li>
            </ul>
            ...
            <Img
              ...
              fileName={
                'ironhacks-process.jpg?alt=media&token=0b68c710-36fb-4992-9c02-604dff758a5e'
              }
              alt="Key Parnters"
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              This IronHacks is not limited to data science experts! We are calling on all of those
              people who are interested in battling the pandemic and who have the interest and
              initiative to learn and iterate quickly over the multiphase hack timeline. Basic
              knowledge of statistics, Python and R is required. But even if you are a beginner or
              you feel a little rusty in Python or R, you should not shy away. You can use our
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              We offer a range of cool prizes and recognition to our IronHackers! Winning hackers
              will have the opportunity to be eligible for cash prizes. In total, we will award{' '}
              <strong>$3000</strong> in our COVID-19 Data Science Challenges. From Improvement
              Spirit, to Best Solution, there is a chance for everyone to gain fame, connect with
              top-level organizations, and be recognized for their excellent solutions to the
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <List
              items={[
                <p>
                  <strong>COVID-19 Data Science Challenge Summer 2020:</strong> This challenge has
                  opened for registration. However, the competition has not yet started. The task
                  will be announced in the week of August 11, 2020. Registration will close after
                  the first submission phase. So what are you waiting for? Register now and find out
                  more!
                </p>,
                <p>
                  <strong>COVID-19 Data Science Challenge Fall 2020:</strong> This challenge has not
                  yet opened yet. We plan to open this challenge on September 29th, 2020.
                </p>,
              ]}
            />
          </Col>
        ...
        <Row rowClass="py-2">
          <Col>
            ...
            <p>
              By partnering with us for the IronHacks COVID-19 Data Science Challenge, organizations
              have the opportunity to take collective action and help society to cope with the
              COVID-19 pandemic.
            </p>
            ...
            <p>
              Join forces with us for this chance to create impact with data-driven insights that
              help policymakers create real change for citizens in the face of the pandemic!
            </p>

            <p>
              <strong>Would you like to support us directly?</strong> You can contact us at{' '}
              <strong>opendigital@purdue.edu</strong> for monetary or in-kind donations to the
              Research Center for Open Digital Innovation at Purdue University.
            </p>
          </Col>
        </Row>
