        ...
        <Section sectionClass="py-5">
          <Row rowClass="py-2">
            <Col>
              ...
              <p>
                In Summer and Fall 2020, we invite aspiring data scientists to join the IronHacks crowd in a COVID-19 Data Science Challenge to predicting COVID-19 impacts. You can watch our recent <a href="https://www.youtube.com/watch?v=ta5i7_I5VT8&feature=youtu.be" className="link--underline">Info Sessions</a> or <a href="https://purdue-student.webex.com/purdue-student/onstage/g.php?MTID=eaabc17b783525278246fc7b228261b3a" className="link--underline">sign-up</a> for upcoming ones to learn more about the COVID-19 data science challenges here.
              </p>
          ...
          <Row rowClass="py-2">
            <Col>
              ...
              <p>
                IronHacks is a global virtual open data hacking platform that allows users to participate in a high-energy IronHacks competition. The IronHacks platform offers participants a no setup workspace with <strong>JupyterLab</strong> and <strong>BigQuery</strong> integration and many powerful features to create novel and useful models and visualizations, such as tutorials and a personal dashboard. After registration, participants can warm-up until sufficient participants have joined to launch the competition. After the start of the competition, a multiphase process will start. Each challenge moves through a four-phased process after a registration and warm-up phase.
              </p>
          ...
          <Row rowClass="py-2">
            <Col>
              ...
              <p>
                We offer a range of cool prizes and recognition to our IronHackers! Winning hackers will have the opportunity to be eligible for cash prizes. In total, we will award <strong>$3000</strong> in our COVID-19 Data Science Challenges. From Improvement Spirit, to Best Solution, there is a chance for everyone to gain fame, connect with top-level organizations, and be recognized for their excellent solutions to the COVID-19 Data Science Challenge!
              </p>
          ...
          <Row rowClass="py-2">
            <Col>
              ...
              <List
                items={[
                  <p><strong>COVID-19 Data Science Challenge Summer 2020:</strong> This challenge has opened for registration. However, the competition has not yet started. The task will be announced in the week of August 11, 2020. Registration will close after the first submission phase. So what are you waiting for? Register now and find out more!</p>,
          ...
          <Row rowClass="py-2">
            <Col>
              ...
              <p>
                <strong>Would you like to support us directly?</strong> You can contact us at <strong>opendigital@purdue.edu</strong> for monetary or in-kind donations to the Research Center for Open Digital Innovation at Purdue University.
              </p>
            </Col>
          </Row>
