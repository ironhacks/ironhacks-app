...
!function(e, t) {
typeof exports==='object'&&typeof module!=='undefined'?t(exports):typeof define==='function'&&define.amd?define(['exports'], t):t((e=e||self).Popper={});
}(this, (function(e) {
  function t(e) {
    ...
    return {}.toString.call(e)!=='[object Window]'?(e=e.ownerDocument)?e.defaultView:window:e;
  } function r(e) {
    ...
    void 0===s&&(s=!1), e=t(e); let f={scrollLeft: 0, scrollTop: 0}; let p={x: 0, y: 0}; return s||(a(o)!=='body'&&(f=o!==n(o)&&i(o)?{scrollLeft: o.scrollLeft, scrollTop: o.scrollTop}:r(o)), i(o)&&((p=t(o)).x+=o.clientLeft, p.y+=o.clientTop)), {x: e.left+f.scrollLeft-p.x, y: e.top+f.scrollTop-p.y, width: e.width, height: e.height};
  } function f(e) {
    return {x: e.offsetLeft, y: e.offsetTop, width: e.offsetWidth, height: e.offsetHeight};
  } function p(e) {
    return a(e)==='html'?e:e.parentNode||e.host||document.ownerDocument||document.documentElement;
  } function c(e) {
    return n(e).getComputedStyle(e);
  } function u(e, t) {
    void 0===t&&(t=[]); let r=function e(t) {
      if (['html', 'body', '#document'].indexOf(a(t))>=0) {return t.ownerDocument.body;} if (i(t)) {
        const n=c(t); if (/auto|scroll|overlay|hidden/.test(n.overflow+n.overflowY+n.overflowX)) {return t;}
      } return e(p(t));
    }(e); return r=(e=a(r)==='body')?n(r):r, t=t.concat(r), e?t:t.concat(u(p(r)));
  } function d(e) {
    let t; return !i(e)||!(t=e.offsetParent)||void 0!==window.InstallTrigger&&c(t).position==='fixed'?null:t;
  } function l(e) {
    const t=n(e); for (e=d(e); e&&['table', 'td', 'th'].indexOf(a(e))>=0;){e=d(e);} return e&&a(e)==='body'&&c(e).position==='static'?t:e||t;
  } function m(e) {
    ...
    void 0===e&&(e={}); const t=e.defaultModifiers; const n=void 0===t?[]:t; const r=void 0===(e=e.defaultOptions)?H:e; return function(e, t, i) {
      function a() {
        ...
        return a(), p.options=Object.assign({}, r, {}, p.options, {}, i), p.scrollParents={reference: o(e)?u(e):[], popper: u(t)}, i=function(e) {
          ...
          let t=e.name; let n=e.options; n=void 0===n?{}:n, typeof(e=e.effect)==='function'&&(t=e({state: p, name: t, instance: v, options: n}), c.push(t||function() {}));
        })), v.update();
      }, forceUpdate: function() {
        if (!d) {
          let e=p.elements; let t=e.reference; if (g(t, e=e.popper)) {
            for (p.rects={reference: s(t, l(e), p.options.strategy==='fixed'), popper: f(e)}, p.reset=!1, p.placement=p.options.placement, p.orderedModifiers.forEach((function(e) {
              return p.modifiersData[e.name]=Object.assign({}, e.data);
            })), t=0; t<p.orderedModifiers.length; t++) {
              if (!0===p.reset){p.reset=!1, t=-1;} else {
                let n=p.orderedModifiers[t]; e=n.fn; let r=n.options; r=void 0===r?{}:r, n=n.name, typeof e==='function'&&(p=e({state: p, options: r, name: n, instance: v})||p);
              }
            }
          }
        }
    ...
    } if ((r=r?y(r):null)!=null) {
      switch (i=r==='y'?'height':'width', e) {
    ...
    let t; let r=e.popper; const o=e.popperRect; const i=e.placement; let a=e.offsets; const s=e.position; const f=e.gpuAcceleration; const p=e.adaptive; let c=window.devicePixelRatio||1; e=Math.round(a.x*c)/c||0, c=Math.round(a.y*c)/c||0; const u=a.hasOwnProperty('x'); a=a.hasOwnProperty('y'); let d; let m='left'; let h='top'; if (p) {
      let v=l(r); v===n(r)&&(v=r.ownerDocument.documentElement), i==='top'&&(h='bottom', c-=v.clientHeight-o.height, c*=f?1:-1), i==='left'&&(m='right', e-=v.clientWidth-o.width, e*=f?1:-1);
    } return r=Object.assign({position: s}, p&&F), f?Object.assign({}, r, ((d={})[h]=a?'0':'', d[m]=u?'0':'', d.transform=(window.devicePixelRatio||1)<2?'translate('+e+'px, '+c+'px)':'translate3d('+e+'px, '+c+'px, 0)', d)):Object.assign({}, r, ((t={})[h]=a?c+'px':'', t[m]=u?e+'px':'', t.transform='', t));
  } function O(e) {
    ...
    if (o==='viewport'){e=j({width: (e=n(e)).innerWidth, height: e.innerHeight, x: 0, y: 0});} else if (i(o)){e=t(o);} else {
    ...
    return t=t==='clippingParents'?function(e) {
      const t=u(e); const n=['absolute', 'fixed'].indexOf(c(e).position)>=0&&i(e)?l(e):e; return o(n)?t.filter((function(e) {
        return o(e)&&D(e, n);
      })):[];
    }(e):[].concat(t), (r=(r=[].concat(t, [r])).reduce((function(t, r) {
      const o=E(e, r); let s=n(r=i(r)?r:e.ownerDocument.documentElement); let f=i(r)?c(r):{}; parseFloat(f.borderTopWidth); let p=parseFloat(f.borderRightWidth)||0; let u=parseFloat(f.borderBottomWidth)||0; const d=parseFloat(f.borderLeftWidth)||0; f=a(r)==='html'; const l=r.clientWidth+p; const m=r.clientHeight+u; return u=r.clientTop, p=r.clientLeft>d?p:f?s.innerWidth-l:r.offsetWidth-l, s=f?s.innerHeight-m:r.offsetHeight-m, r=r.clientLeft, t.top=Math.max(o.top+u, t.top), t.right=Math.min(o.right-p, t.right), t.bottom=Math.min(o.bottom-s, t.bottom), t.left=Math.max(o.left+r, t.left), t;
    ...
    const t=e.state; const n=e.name; const r=void 0===(e=e.options.offset)?[0, 0]:e; const o=(e=S.reduce((function(e, n) {
      let o=t.rects; let i=v(n); const a=['left', 'top'].indexOf(i)>=0?-1:1; let s=typeof r==='function'?r(Object.assign({}, o, {placement: n})):r; return o=(o=s[0])||0, s=((s=s[1])||0)*a, i=['left', 'right'].indexOf(i)>=0?{x: s, y: o}:{x: o, y: s}, e[n]=i, e;
    ...
    const t=e.state; let n=e.options; if (e=e.name, !t.modifiersData[e]._skip) {
      let r=n.fallbackPlacements; const o=n.padding; const i=n.boundary; const a=n.rootBoundary; const s=void 0===(n=n.flipVariations)||n; let f=v(n=t.options.placement); r=r||(f!==n&&s?function(e) {
        if (v(e)==='auto') {return [];} const t=O(e); return [M(e), t, M(t)];
        ...
        return v(n)==='auto'?e.concat(function(e, t) {
        ...
        const l=p[d]; let m=v(l); let h=l.split('-')[1]==='start'; const g=['top', 'bottom'].indexOf(m)>=0; let b=g?'width':'height'; const y=W(t, {placement: l, boundary: i, rootBoundary: a, padding: o}); if (h=g?h?'right':'left':h?'bottom':'top', r[b]>n[b]&&(h=O(h)), b=O(h), (m=[y[m]<=0, y[h]<=0, y[b]<=0]).every((function(e) {
          return e;
        }))) {
          u=l, f=!1; break;
        }c.set(l, m);
    ...
    const t=e.state; let n=e.options; e=e.name; let r=n.mainAxis; let o=void 0===r||r; r=void 0!==(r=n.altAxis)&&r; let i=n.tether; i=void 0===i||i; let a=n.tetherOffset; let s=void 0===a?0:a; n=W(t, {boundary: n.boundary, rootBoundary: n.rootBoundary, padding: n.padding}), a=v(t.placement); let p=t.placement.split('-')[1]; let c=!p; const u=y(a); a=u==='x'?'y':'x'; const d=t.modifiersData.popperOffsets; const l=t.rects.reference; let m=t.rects.popper; const h=typeof s==='function'?s(Object.assign({}, t.rects, {placement: t.placement})):s; if (s={x: 0, y: 0}, o) {
      let g=u==='y'?'top':'left'; let b=u==='y'?'bottom':'right'; const x=u==='y'?'height':'width'; o=d[u]; const w=d[u]+n[g]; const O=d[u]-n[b]; const M=i?-m[x]/2:0; let D=p==='start'?l[x]:m[x]; p=p==='start'?-m[x]:-l[x], m=t.elements.arrow, m=i&&m?f(m):{width: 0, height: 0}; let j=t.modifiersData['arrow#persistent']?t.modifiersData['arrow#persistent'].padding:{top: 0, right: 0, bottom: 0, left: 0}; g=j[g], b=j[b], m=Math.max(0, Math.min(Math.abs(l[x]-m[x]), m[x])), j=t.modifiersData.offset?t.modifiersData.offset[t.placement][u]:0, D=t.modifiersData.popperOffsets[u]+(c?l[x]/2-M-m-g-h:D-m-g-h)-j, c=t.modifiersData.popperOffsets[u]+(c?-l[x]/2+M+m+b+h:p+m+b+h)-j, i=Math.max(i?Math.min(w, D):w, Math.min(o, i?Math.max(O, c):O)), t.modifiersData.popperOffsets[u]=i, s[u]=i-o;
    }r&&(r=d[a], i=Math.max(r+n[u==='x'?'top':'left'], Math.min(r, r-n[u==='x'?'bottom':'right'])), t.modifiersData.popperOffsets[a]=i, s[a]=i-r), t.modifiersData[e]=s;
  }, requiresIfExists: ['offset']}, {name: 'arrow', enabled: !0, phase: 'main', fn: function(e) {
    let t; const n=e.state; e=e.name; let r=n.elements.arrow; let o=n.modifiersData.popperOffsets; let i=v(n.placement); const a=y(i); if (i=['left', 'right'].indexOf(i)>=0?'height':'width', r) {
      const s=n.modifiersData[e+'#persistent'].padding; r=f(r), o=Math.max(s[a==='y'?'top':'left'], Math.min(n.rects.popper[i]/2-r[i]/2+((n.rects.reference[i]+n.rects.reference[a]-o[a]-n.rects.popper[i])/2-(o[a]-n.rects.reference[a])/2), n.rects.popper[i]-r[i]-s[a==='y'?'bottom':'right'])), n.modifiersData[e]=((t={})[a]=o, t);
    }
  }, effect: function(e) {
    const t=e.state; let n=e.options; e=e.name; let r=n.element; r=void 0===r?'[data-popper-arrow]':r, n=void 0===(n=n.padding)?0:n, (typeof r!=='string'||(r=t.elements.popper.querySelector(r)))&&D(t.elements.popper, r)&&(t.elements.arrow=r, t.modifiersData[e+'#persistent']={padding: P(typeof n!=='number'?n:L(n, T))});
