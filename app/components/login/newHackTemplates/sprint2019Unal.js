...
export const indexContent = `<!DOCTYPE html>
    ...
    <body>
      ...
      <p>
        Below you will find a GoogleMaps demo, PLEASE DO NOT MODIFY the google API key, other wise you will have to provide your own key. <br/> You can find all the JavaScript on the "map.js" on the "js" folder.
      </p>
